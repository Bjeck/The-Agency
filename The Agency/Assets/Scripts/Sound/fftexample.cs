...
public class fftexample : MonoBehaviour {
	...
	/*	batches[0].AddRange((SubArray(spectrum,0,64)).ToArray());
		batches[1].AddRange((SubArray(spectrum,64,64)).ToArray());
		batches[2].AddRange((SubArray(spectrum,128,64)).ToArray());
		batches[3].AddRange((SubArray(spectrum,192,64)).ToArray());
		batches[4].AddRange((SubArray(spectrum,256,128)).ToArray());
		batches[5].AddRange((SubArray(spectrum,384,128)).ToArray());
		batches[6].AddRange((SubArray(spectrum,512,256)).ToArray());
		batches[7].AddRange((SubArray(spectrum,768,256)).ToArray());*/


		/*batches[0].AddRange((SubArray(spectrum,0,4)).ToArray());
		batches[1].AddRange((SubArray(spectrum,4,6)).ToArray());
		batches[2].AddRange((SubArray(spectrum,10,10)).ToArray());
		batches[3].AddRange((SubArray(spectrum,20,20)).ToArray());
		batches[4].AddRange((SubArray(spectrum,40,40)).ToArray());
		batches[5].AddRange((SubArray(spectrum,80,80)).ToArray());
		batches[6].AddRange((SubArray(spectrum,160,160)).ToArray());
		batches[7].AddRange((SubArray(spectrum,240,10)).ToArray());*/
